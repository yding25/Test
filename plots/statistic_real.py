...
# -----------------------------------------
path_our_ANN_8 = utils.root_path() + 'results/3/test_ANN_100_3/'
...
# -----------------------------------------
path_nosafe_5 = utils.root_path() + 'results/3/nosafe_ANN_3/'
...
# -----------------------------------------
path_nocost_8 = utils.root_path() + 'results/3/nocost_ANN_3/'
...
# -----------------------------------------
path_nopref_8 = utils.root_path() + 'results/3/nopref_ANN_3/'
...
xticks = ['No-Safe', 'No-Pref', 'No-Cost', 'GLAD-SVM \n(ours)', 'GLAD-Net \n(ours)', 'No-Safe', 'No-Pref', 'No-Cost', 'GLAD-SVM \n(ours)', 'GLAD-Net \n(ours)']
...
# plot NoPref
# -----------------------------------------
ax.bar(X[1] - params['bar_interval'], Y_nopref_8, width=params['bar_width'], yerr=Y_nopref_8_std, hatch=params['hatch'][0], color=params['color'][0], capsize=params['error_capsize'])
ax.bar(X[6] + params['bar_interval'], Y_nopref_5, width=params['bar_width'], yerr=Y_nopref_5_std, hatch=params['hatch'][1], color=params['color'][1], capsize=params['error_capsize'])


# -----------------------------------------
# plot NoCost
# -----------------------------------------
ax.bar(X[2] - params['bar_interval'], Y_nocost_8, width=params['bar_width'], yerr=Y_nocost_8_std, hatch=params['hatch'][0], color=params['color'][0], capsize=params['error_capsize'])
ax.bar(X[7] + params['bar_interval'], Y_nocost_5, width=params['bar_width'], yerr=Y_nocost_5_std, hatch=params['hatch'][1], color=params['color'][1], capsize=params['error_capsize'])
...
# legend
# -----------------------------------------
ax.legend([legend1, legend2], [r'Heavy Traffic ($\lambda = 0.08$)', r'Normal Traffic ($\lambda = 0.05$)'], fontsize=params['legend_fontsize'])
